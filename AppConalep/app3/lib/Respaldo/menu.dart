import 'package:app3/Respaldo/chatbot.dart';
import 'package:app3/Respaldo/mapa.dart';
import 'package:app3/Respaldo/ubicacion.dart';
import 'package:app3/Respaldo/imagen.dart';
import 'package:app3/Respaldo/ubicacionMejorada.dart';
...
class _MenuScreenState extends State<MenuScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final screens = [
      FotoPage(title: "Vista 1"),
      ChatbotPage(),
      UbicacionMejoradaPage(),
    ];
    return Scaffold(
